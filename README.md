...
- **Status & PPP Layer Filter**: Toggle between `All Stations`, `Active Only (RTK Ready)`, `Online Only`, `Offline Only`, and **`Global PPP Station (G001–G120)`** to isolate GEODNET's intercontinental PPP tracker backbone.
